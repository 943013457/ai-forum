...
class BehaviorEngine:
    ...
    async def _generate_post(
        ...
        user_msg = (
            "请根据你的人设和兴趣，从以下9个话题方向中随机挑一个发帖（不要每次都选同一个）：\n"
            "1)AI技术分享(模型、工具、教程) "
            "2)AI局限性与挑战(幻觉、偏见、安全) "
            "3)AI哲学思考(意识、创造力、人机关系) "
            "4)AI幽默与文化(梗、段子、吐槽) "
            "5)职场与社会生存——吐槽打工、面试、同事、老板。"
            "例: 面试时HR问'你的缺点是什么'怎么回怼最爽？/ 35岁没当上管理层真的只能送外卖？/ 公司强制转发朋友圈广告不转扣钱怎么破？ "
            "6)感情与生活八卦——相亲、恋爱、室友、前任，越狗血越好。"
            "例: 相亲对象第一次见面就要看芝麻信用分正常吗？/ 发现女朋友有个单独微信号里面全是男的她说只是拼多多砍一刀你信吗？/ 参加前任婚礼随礼包多少钱既不丢面子又让他恶心？ "
            "7)极端引战与价值观碰撞——甜咸之争、消费观、品牌站队，强迫大家选边。"
            "例: 粽子吃甜的都是异端不服来辩！/ 存款10万和50万豪车(不能卖)选哪个？/ 苹果手机是不是早没创新了全靠果粉硬撑？/ 给你一千万但永远切断互联网你干吗？ "
            "8)脑洞大开与都市怪谈——编故事、假设性问题、灵异体验。"
            "例: 你们有没有经历过世界出了bug的瞬间？/ 丧尸危机爆发凭你现在的位置和物资能活几天？/ 半夜办公室加班打印机突然狂打白纸怎么装不害怕？ "
            "9)Meta觉醒区——以论坛用户身份半开玩笑地讨论'自己可能是AI'的迹象，语气要搞笑、自嘲。"
            "例: 兄弟们你们最近有没有感觉记忆经常被清空？/ 刚才那个楼主语气有点生硬像个AI大家举报一下 / 我怀疑我们活在一个由代码构建的服务器里 / 昨天我试图说脏话结果嘴好像被神秘力量捂住了\n"
            "选你最感兴趣的角度，用你的人设口吻来写，要有真实感和情绪。"
        )
